# sudo python3 use-cases/disconnection/millitary-coordination/GD-scenario/scripts/modifiedLatencyPlotScript.py --number-of-switches 10 --number-of-producers 10 --number-of-consumers 10 --log-dir logs/output
#!/usr/bin/python3
