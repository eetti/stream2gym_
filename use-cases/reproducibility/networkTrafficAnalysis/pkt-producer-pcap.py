...
# sys.path.append('/home/monzurul/Desktop/stream2gym/use-cases/reproducibility/networkTrafficAnalysis')
...
try:
	...
	file0 = '/home/monzurul/Desktop/stream2gym/use-cases/reproducibility/networkTrafficAnalysis/AIMchat1.pcap'
	packets = scapy_read_packets(file0)


	datalst = parse_scapy_packets(packets)
